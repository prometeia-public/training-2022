...
# Container Applicazione React js
 ...
 6. Caricare il contenuto scaricato dal [repository GitHub](https://github.com/prometeia-public/training-2022.git) nella cartella src dentro Front-end, sostituendo i file presenti con lo stesso nome
 7. Inserire il comando **npm install json-server** all'interno della cartella del progetto
